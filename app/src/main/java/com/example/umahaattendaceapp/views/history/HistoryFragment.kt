package com.example.umahaattendaceapp.views.history
...
import com.example.umahaattendaceapp.databinding.FragmentHistoryBinding
import com.example.umahaattendaceapp.date.MyDate.fromTimeStampToDate
import com.example.umahaattendaceapp.date.MyDate.toCalendar
import com.example.umahaattendaceapp.date.MyDate.toDate
import com.example.umahaattendaceapp.date.MyDate.toDay
import com.example.umahaattendaceapp.date.MyDate.toMonth
import com.example.umahaattendaceapp.date.MyDate.toTime
import com.example.umahaattendaceapp.dialog.MyDialog
import com.example.umahaattendaceapp.hawkstorage.HawkStorage
import com.example.umahaattendaceapp.model.History
                            ...
                            for (dataHistory in dataHistories!!){
                                ...
                                if (status == 1){
                                    ...
                                    if (calendarHistoryCheckOut != null){
                                        events.add(EventDay(calendarHistoryCheckOut, R.drawable.baseline_check_circle_primary_24))
                                    }
                                    ...
                                    if (calendarHistoryCheckIn != null){
                                        events.add(EventDay(calendarHistoryCheckIn, R.drawable.baseline_check_circle_yellow_light_24))
                                    }
